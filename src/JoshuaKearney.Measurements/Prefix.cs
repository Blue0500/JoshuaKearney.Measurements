...
namespace JoshuaKearney.Measurements {
    ...
    public static class Prefix {
        ...
        /// <param name="unit">The unit.</param>
        /// <returns></returns>
        public static Unit<T> Deca<T>(PrefixableUnit<T> unit) where T : IMeasurement<T> {
            Validate.NonNull(unit, nameof(unit));
        ...
        /// <param name="unit">The unit.</param>
        /// <returns></returns>
        public static Unit<T> Femto<T>(PrefixableUnit<T> unit) where T : IMeasurement<T> {
            Validate.NonNull(unit, nameof(unit));
        ...
        /// <param name="unit">The unit.</param>
        /// <returns></returns>
        public static Unit<T> Gibi<T>(PrefixableUnit<T> unit) where T : IMeasurement<T> {
            Validate.NonNull(unit, nameof(unit));
