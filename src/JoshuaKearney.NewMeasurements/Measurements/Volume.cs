...
namespace JoshuaKearney.Measurements {
    public sealed class Volume : Term<Volume, Distance, Area> {
        ...
        public static class Units {
            ...
            private static Lazy<Unit<Volume>> inchCubed = new Lazy<Unit<Volume>>(() => 
            Distance.Units.Inch.Cube().ToUnit("in^3"));
        ...
        private class VolumeProvider : CompoundMeasurementProvider<Volume, Distance, Area> {
            ...
            public override IEnumerable<Unit<Volume>> ParsableUnits => new Unit<Volume>[] { MeterCubed };
